...
const Dashboard = () => {
  ...
  const dashboardCards = [
    ...
    { title: 'Completed', value: data.completedBookings, icon: assets.booking_colored_icon, tone: 'bg-emerald-50' },
  ];
  ...
  return (
    <div className="px-4 pt-10 md:px-10 pb-10 flex-1">
      ...
      <div className="mt-6 rounded-2xl border border-borderColor bg-linear-to-r from-primary/5 via-white to-primary/10 p-5 md:p-6">
      ...
      <div className="grid sm:grid-cols-2 xl:grid-cols-4 gap-4 my-6">
          ...
          <div className="mt-4 space-y-3">
            ...
            {!loading &&
              data.recentBookings.map((booking) => (
                <div
                  key={booking._id}
                  className="flex items-center justify-between rounded-lg border border-borderColor px-3 py-2"
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <p className={`px-2.5 py-0.5 border rounded-full text-xs ${statusClass(booking.bookingStatus)}`}>
